...
export const mockLeetCodeStats = {
  username: "knight_coder",
  rank: 48230,
  totalSolved: 187,
  categories: [
    { name: "Arrays", solved: 45, total: 80, color: "#f0a500" },
    { name: "Trees", solved: 32, total: 55, color: "#00e5ff" },
    { name: "Graphs", solved: 18, total: 45, color: "#9b4dff" },
    { name: "Sorting", solved: 28, total: 35, color: "#39ff8a" },
    { name: "DP", solved: 22, total: 60, color: "#ff4560" },
    { name: "Strings", solved: 30, total: 50, color: "#ff9f43" },
    { name: "Binary Search", solved: 12, total: 25, color: "#54a0ff" },
  ],
  easy: 78,
  medium: 89,
  hard: 20,
...
export const mockCodeforcesStats = {
  username: "knight_coder",
  rank: "Specialist",
  rating: 1524,
  totalSolved: 312,
  categories: [
    { name: "Implementation", solved: 88, total: 120, color: "#f0a500" },
    { name: "Greedy", solved: 54, total: 80, color: "#00e5ff" },
    { name: "Math", solved: 67, total: 90, color: "#9b4dff" },
    { name: "Graphs", solved: 30, total: 60, color: "#39ff8a" },
    { name: "DP", solved: 41, total: 75, color: "#ff4560" },
    { name: "Sorting", solved: 32, total: 40, color: "#ff9f43" },
  ],
};
...
export const castleProgress = {
  solved: 4,
  goal: 14, // total problems in roadmap
};
